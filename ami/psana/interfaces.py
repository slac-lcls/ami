...
from .detector import AreaDetectorHelper, DdlHelper, DdlHelperMeta, Detector, DetectorMeta, MultiPanelHelper
...
class RawUsdUsbDetector(DdlHelper, metaclass=DdlHelperMeta, methods=psana.UsdUsb.Data):
    pass
...
class UsdUsbDetector(
    ...
    overrides={
        "encoder_count": amitypes.MultiChannelInt,
