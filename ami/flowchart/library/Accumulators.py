...
class Pick1(Node):
    ...
    def __init__(self, name):
        super().__init__(
            name, terminals={"In": {"io": "in", "ttype": T}, "Out": {"io": "out", "ttype": T}}, global_op=True
        )
...
class PickN(CtrlNode):
    ...
    def __init__(self, name):
        super().__init__(
            name,
            terminals={"In": {"io": "in", "ttype": T}, "Out": {"io": "out", "ttype": Array1d}},
            allowAddInput=True,
            global_op=True,
        )
...
class Accumulator():
    ...
    def reset(self, *args):
        ...
        def to_operation(self, **kwargs):
            ...
            node = gn.Accumulator(
                name=self.name() + "_accumulated", **kwargs, res_factory=proc.res_factory, reduction=proc
            )
            return node
