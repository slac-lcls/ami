...
Usage::
    ...
    # Import
    # ------
    from ami.flowchart.library.HPolar import HPolar
...
2022-05-13 copied froom lcls2/psana/psana/pyalgos/generic/HPolar.py - import is changed
"""

import math
import numpy as np

from ami.flowchart.library.HBins import HBins
...
class HPolar():
    ...
    def print_ndarrs(self):
        print('%s n-d arrays: TBD' % self.__class__.__name__)
