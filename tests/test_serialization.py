...
from ami.data import CollectorMessage, Deserializer, MsgTypes, Serializer, pa
...
def collector_msg():
    return CollectorMessage(
        ...
        name="fake",
        version=1,
        payload={"foo": 5, "baz": "bat", "bar": [1, 2, 4]},
    )
...
@pytest.mark.parametrize("serializer", serializers, indirect=True)
